...
const translations = {
  en: {
    ...
    // Image titles
    "image.security.trivy": "Trivy Pipeline Failing Due to Critical Vulnerabilities",
    "image.security.network": "NetworkPolicies List in Kubernetes",
    "image.security.secrets": "CronJob Code or Secret Configuration",
    "image.observability.grafana": "Main Grafana Dashboard at Cluster Level",
    "image.observability.kibana": "Logs in Kibana Interface",
    "image.observability.linkerd": "Service Mesh Topology in Linkerd",
    "image.observability.locust": "Locust Report Charts",
    "image.observability.chaos": "Latency Metric in Linkerd During Chaos Test",
    "image.quality.sonarqube": "SonarQube Interface with Code Analysis",
    "image.architecture.infrastructure": "Infrastructure Architecture",
    "image.architecture.kubernetes": "Kubernetes Architecture",
    "image.gitops.workflow": "Automated GitOps Workflow",
    "image.gitops.branches": "Branch and Environment Relationship",
  },
  es: {
    // Navbar
    "nav.home": "Inicio",
